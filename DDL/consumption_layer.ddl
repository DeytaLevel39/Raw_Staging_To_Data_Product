...
create or replace view consumption_layer.v_comp_customers_as_is as
...
create or replace view consumption_layer.v_comp_orders_as_is as
...
create or replace view consumption_layer.v_comp_customer_orders_as_is as
...
create or replace view consumption_layer.v_comp_customer_history as
